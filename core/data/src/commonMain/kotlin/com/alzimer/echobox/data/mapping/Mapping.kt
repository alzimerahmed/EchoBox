package com.alzimer.echobox.data.mapping

import com.alzimer.echobox.data.parser.toListThumbnail
...
import com.alzimer.echobox.domain.data.model.metadata.Line
...
import com.alzimer.echobox.spotify.model.response.spotify.CanvasResponse
import com.alzimer.echobox.spotify.model.response.spotify.SpotifyLyricsResponse
import com.alzimer.echobox.lyrics.models.response.LyricsResponse
import com.alzimer.echobox.lyrics.models.response.TranslatedLyricsResponse
import com.alzimer.echobox.lyrics.parser.parseRichSyncLyrics
import com.alzimer.echobox.lyrics.parser.parseSyncedLyrics
import com.alzimer.echobox.lyrics.parser.parseUnsyncedLyrics
...
internal fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                com.alzimer.echobox.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            com.alzimer.echobox.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
...
internal fun com.alzimer.echobox.lyrics.domain.Lyrics.toLyrics(): Lyrics {
...
internal fun Lyrics.toLibraryLyrics(): com.alzimer.echobox.lyrics.domain.Lyrics =
    com.alzimer.echobox.lyrics.domain.Lyrics(
        lyrics =
            com.alzimer.echobox.lyrics.domain.Lyrics.LyricsX(
                lines =
                    this.lines?.map {
                        com.alzimer.echobox.lyrics.domain.Lyrics.LyricsX.Line(
                            endTimeMs = it.endTimeMs,
                            startTimeMs = it.startTimeMs,
                            syllables = listOf(),
                            words = it.words,
...
internal fun SearchSuggestions.toDomainSearchSuggestions(): com.alzimer.echobox.domain.data.model.searchResult.SearchSuggestions =
    com.alzimer.echobox.domain.data.model.searchResult.SearchSuggestions(
...
internal fun AccountInfo.toDomainAccountInfo(): com.alzimer.echobox.domain.data.model.account.AccountInfo =
    com.alzimer.echobox.domain.data.model.account.AccountInfo(
        name = this.name,
        email = this.email,
        pageId = this.pageId,
