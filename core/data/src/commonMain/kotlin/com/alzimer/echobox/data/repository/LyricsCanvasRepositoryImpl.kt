...
import com.alzimer.echobox.data.mapping.toCanvasResult
import com.alzimer.echobox.data.mapping.toLyrics
...
import com.alzimer.echobox.domain.data.model.metadata.EchoBoxLyrics
...
import com.alzimer.echobox.domain.utils.toPlainLrcString
import com.alzimer.echobox.domain.utils.toRichSyncLrcString
import com.alzimer.echobox.domain.utils.toSyncedLrcString
...
import com.alzimer.echobox.aiservice.AiClient
import com.alzimer.echobox.lyrics.EchoBoxLyricsClient
import com.alzimer.echobox.lyrics.am.AMAlbumResource
import com.alzimer.echobox.lyrics.am.AMEditorialVideo
import com.alzimer.echobox.lyrics.am.AMMotionVideo
import com.alzimer.echobox.lyrics.am.AMSongWithAlbum
import com.alzimer.echobox.lyrics.am.toImageUrl
import com.alzimer.echobox.lyrics.models.request.LyricsBody
import com.alzimer.echobox.lyrics.models.request.TranslatedLyricsBody
import com.alzimer.echobox.lyrics.parser.parseTtmlLyrics
...
internal class LyricsCanvasRepositoryImpl(
    ...
    private val simpMusicLyrics: EchoBoxLyricsClient,
    ...
    // EchoBox Lyrics
    private val simpMusicLyricsTag = "EchoBoxLyricsRepository"

    override fun getEchoBoxLyrics(videoId: String): Flow<Resource<Lyrics>> =
        flow {
            simpMusicLyrics
                .getLyrics(videoId)
                .onSuccess { lyrics ->
    ...
    override fun getEchoBoxTranslatedLyrics(
        videoId: String,
        language: String,
    ): Flow<Resource<Lyrics>> =
        flow {
    ...
    override fun voteEchoBoxLyrics(
        lyricsId: String,
        upvote: Boolean,
    ...
    override fun voteEchoBoxTranslatedLyrics(
    ...
    override fun insertEchoBoxLyrics(
        dataStoreManager: DataStoreManager,
        track: Track,
        duration: Int,
        lyrics: Lyrics,
    ...
    override fun insertEchoBoxTranslatedLyrics(
        dataStoreManager: DataStoreManager,
        track: Track,
