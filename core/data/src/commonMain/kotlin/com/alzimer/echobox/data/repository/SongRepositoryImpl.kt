...
import com.alzimer.echobox.data.mapping.toSongItemForDownload
import com.alzimer.echobox.data.mapping.toWatchEndpoint
...
import com.alzimer.echobox.domain.utils.isRadioQueueId
    ...
    override suspend fun downloadAllLikedSongs(): Int =
        withContext(Dispatchers.IO) {
            val pending =
                getFullDataFromDB { limit, offset ->
                    localDataSource.getLikedSongs(limit, offset)
                }.filter { it.downloadState != DownloadState.STATE_DOWNLOADED && !it.videoId.isLocalFileId() }
...
//        }
     ...
     * is what [com.alzimer.echobox.kotlinytmusicscraper.models.PlaylistPanelRenderer.Content.track] reads.
     */
