...
import com.alzimer.echobox.domain.data.model.mood.genre.GenreObject
import com.alzimer.echobox.domain.data.model.mood.genre.ItemsPlaylist
import com.alzimer.echobox.domain.data.model.mood.genre.ItemsSong
import com.alzimer.echobox.domain.data.model.mood.genre.Title
import com.alzimer.echobox.domain.data.model.mood.moodmoments.Content
import com.alzimer.echobox.domain.data.model.mood.moodmoments.Item
import com.alzimer.echobox.domain.data.model.mood.moodmoments.MoodsMomentObject
...
import com.alzimer.echobox.domain.data.model.mood.genre.Content as GenreContent
                    ...
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                ...
                                // EchoBox draws them as full-size cards. Same w120 -> w544 bump
