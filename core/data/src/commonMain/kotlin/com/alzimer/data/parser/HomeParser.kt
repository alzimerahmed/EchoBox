package com.alzimer.echobox.data.parser
...
import com.alzimer.echobox.kotlinytmusicscraper.models.SectionListRenderer
...
fun Thumbnail.toThumbnail(): com.alzimer.echobox.domain.data.model.searchResult.songs.Thumbnail =
    com.alzimer.echobox.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.alzimer.echobox.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.alzimer.echobox.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
