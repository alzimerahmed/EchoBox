...
import com.alzimer.echobox.domain.data.entities.PodcastWithEpisodes
...
import com.alzimer.echobox.domain.data.entities.analytics.EventArtistEntity
import com.alzimer.echobox.domain.data.entities.analytics.PlaybackEventEntity
import com.alzimer.echobox.domain.data.entities.analytics.query.DecadeCount
import com.alzimer.echobox.domain.data.entities.analytics.query.PlaybackSample
...
import com.alzimer.echobox.domain.data.entities.analytics.query.TopPlayedArtistTime
 ...
 *
 * Kept in step with the copy in [com.alzimer.echobox.data.db.datasource.LocalDataSource] and with the
...
interface DatabaseDao {
     ...
     * [com.alzimer.echobox.data.db.datasource.LocalDataSource.insertSong], which is right when a track
