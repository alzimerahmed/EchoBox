package com.alzimer.echobox.media3.carapp
 ...
 */
@UnstableApi
internal class EchoBoxCarAppService : CarAppService() {
    ...
    override fun onCreateSession(): Session = EchoBoxCarSession()
}

@UnstableApi
internal class EchoBoxCarSession : Session() {
    ...
    private companion object {
        private const val TAG = "EchoBoxCarSession"
