package com.alzimer.echobox.media3.di
...
import com.alzimer.echobox.media3.cast.CastHandoffManager
import com.alzimer.echobox.media3.cast.CastStreamResolver
import com.alzimer.echobox.media3.exoplayer.CrossfadeExoPlayerAdapter
import com.alzimer.echobox.media3.extension.isFullyCached
import com.alzimer.echobox.media3.repository.CacheRepositoryImpl
import com.alzimer.echobox.media3.service.SimpleMediaService
import com.alzimer.echobox.media3.service.callback.SimpleMediaSessionCallback
import com.alzimer.echobox.media3.service.download.DownloadUtils
import com.alzimer.echobox.media3.service.mediasourcefactory.MergingMediaSourceFactory
import com.alzimer.echobox.media3.utils.CoilBitmapLoader
...
import com.alzimer.echobox.cast.initCast
import com.alzimer.echobox.cast.wrapWithCastPlayer
...
private val mediaServiceModule =
    module {
        ...
        // Cast support in the full build; com.alzimer.echobox.cast no-ops back to the same instance
...
private fun provideMergingMediaSource(
    ...
    MergingMediaSourceFactory(
        ...
        // On-device files skip the cache + resolver stack: DefaultDataSource already knows
        // content:// and file://, and there is no network URL to resolve or bytes worth caching.
