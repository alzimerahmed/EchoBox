package com.alzimer.echobox.media3.service
...
import com.alzimer.echobox.common.MEDIA_NOTIFICATION
...
import com.alzimer.echobox.media3.extension.toCommandButton
...
internal class SimpleMediaService :
    MediaLibraryService(),
    KoinComponent {
    private val coroutineScope by inject<CoroutineScope>(named(com.alzimer.echobox.common.Config.SERVICE_SCOPE))
    ...
    private val player: Player by inject<Player>(qualifier = named(com.alzimer.echobox.common.Config.MAIN_PLAYER))
