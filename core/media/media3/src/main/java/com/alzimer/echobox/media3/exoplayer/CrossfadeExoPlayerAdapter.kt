package com.alzimer.echobox.media3.exoplayer
...
import com.alzimer.echobox.media3.audio.BiquadFilter
import com.alzimer.echobox.media3.audio.ConvolutionReverbAudioProcessor
import com.alzimer.echobox.media3.audio.CrossfadeFilterAudioProcessor
import com.alzimer.echobox.media3.audio.EchoAudioProcessor
import com.alzimer.echobox.media3.audio.EqualizerAudioProcessor
import com.alzimer.echobox.media3.audio.EqualizerCurve
import com.alzimer.echobox.media3.audio.SleepFadeAudioProcessor
import com.alzimer.echobox.media3.exoplayer.CrossfadeExoPlayerAdapter.Companion.SPEED_PITCH_STEP
import com.alzimer.echobox.media3.service.mediasourcefactory.MergingMediaSourceFactory
 ...
 *
 * Architecture mirrors [com.echobox.media_jvm.GstreamerPlayerAdapter]:
                        ...
                        if (retryCount < maxRetryCount) {
                            ...
                            coroutineScope.launch {
                                try {
                                    ...
                                    streamRepository.invalidateFormat("${com.alzimer.echobox.common.MERGING_DATA_TYPE.VIDEO}$currentVideoId")
