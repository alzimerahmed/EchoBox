package com.echobox.media_jvm.audio

import com.alzimer.echobox.domain.data.player.ReverbImpulseResponse
...
private fun reverbFolderPath(): String =
    System.getProperty("user.home") + File.separator + ".echobox" + File.separator + "reverb"
