...
import com.alzimer.echobox.lyrics.am.AMTokenManager
...
import com.alzimer.echobox.lyrics.models.request.VoteBody
...
class EchoBoxLyrics {
    ...
    private fun createClient() =
        HttpClient(getEngine()) {
            ...
            install(HttpCache)
            install(CurlLogger) {
                logger = { Logger.d("EchoBoxLyrics", it) }
            }
            install(HttpSend) {
                maxSendCount = 100
            }
            ...
            if (proxy != null) {
                engine {
                    proxy = this@EchoBoxLyrics.proxy
                }
            }
        }
    ...
    private fun HttpRequestBuilder.buildDefaultHeaders(
        ...
        headers {
            ...
            header(HttpHeaders.UserAgent, "EchoBoxLyrics/1.0")
