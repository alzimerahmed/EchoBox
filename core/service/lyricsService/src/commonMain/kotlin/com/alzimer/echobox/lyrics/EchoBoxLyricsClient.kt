package com.alzimer.echobox.lyrics

import com.alzimer.echobox.ktorext.crypto.Hmac
import com.alzimer.echobox.ktorext.crypto.HmacUri
...
import com.alzimer.echobox.lyrics.am.parseAMHlsVariants
import com.alzimer.echobox.lyrics.am.pickAMRendition
import com.alzimer.echobox.lyrics.am.AMArtistResource
import com.alzimer.echobox.lyrics.am.AMSearchResponse
...
import com.alzimer.echobox.lyrics.models.response.BaseResponse
import com.alzimer.echobox.lyrics.models.response.BetterLyricsResponse
import com.alzimer.echobox.lyrics.models.response.LrclibObject
...
private const val TAG = "EchoBoxLyricsClient"

class EchoBoxLyricsClient {
    private val algorithm = ""

    private val hmacService = Hmac("HmacSHA256", "simpmusic-lyrics")
    private val lyricsService = EchoBoxLyrics()
