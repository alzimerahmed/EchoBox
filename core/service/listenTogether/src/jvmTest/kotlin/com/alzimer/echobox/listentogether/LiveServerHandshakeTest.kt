        ...
        runBlocking {
            val client =
                ListenTogetherClient(
                    clientVersion = "echobox-live-test",
                    userAgent = "EchoBox/test (com.alzimer.echobox.test; JVM)",
                )
            ...
            try {
                ...
                println("→ create_room")
                assertTrue(
                    client.send(MessageTypes.CREATE_ROOM, CreateRoomPayload(username = "EchoBoxTest")),
