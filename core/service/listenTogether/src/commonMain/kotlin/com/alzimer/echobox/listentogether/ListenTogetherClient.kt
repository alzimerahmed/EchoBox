 ...
 * (MetrolistGroup/metroserver, GPL-3.0 — the same licence as this project) so that EchoBox
 ...
 */
package com.alzimer.echobox.listentogether
...
class ListenTogetherClient(
    ...
    companion object {
         ...
         * makes EchoBox interoperable out of the box.
         */
