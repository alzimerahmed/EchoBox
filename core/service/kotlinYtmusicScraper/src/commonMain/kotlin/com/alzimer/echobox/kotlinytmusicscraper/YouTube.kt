package com.alzimer.echobox.kotlinytmusicscraper

import com.eygraber.uri.toKmpUri
import com.alzimer.echobox.common.ITAG
import com.alzimer.echobox.kotlinytmusicscraper.YouTube.Companion.DEFAULT_VISITOR_DATA
import com.alzimer.echobox.kotlinytmusicscraper.extension.toListFormat
import com.alzimer.echobox.kotlinytmusicscraper.extractor.ExtractSource
import com.alzimer.echobox.kotlinytmusicscraper.models.AccountInfo
...
import com.alzimer.echobox.kotlinytmusicscraper.models.ArtistItem
import com.alzimer.echobox.kotlinytmusicscraper.models.BrowseEndpoint
import com.alzimer.echobox.kotlinytmusicscraper.models.GridRenderer
import com.alzimer.echobox.kotlinytmusicscraper.models.MediaType
import com.alzimer.echobox.kotlinytmusicscraper.models.MusicCarouselShelfRenderer
import com.alzimer.echobox.kotlinytmusicscraper.models.MusicShelfRenderer
import com.alzimer.echobox.kotlinytmusicscraper.models.MusicTwoRowItemRenderer
import com.alzimer.echobox.kotlinytmusicscraper.models.PlaylistItem
import com.alzimer.echobox.kotlinytmusicscraper.models.ReturnYouTubeDislikeResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.Run
import com.alzimer.echobox.kotlinytmusicscraper.models.SearchSuggestions
import com.alzimer.echobox.kotlinytmusicscraper.models.SongInfo
import com.alzimer.echobox.kotlinytmusicscraper.models.SongItem
import com.alzimer.echobox.kotlinytmusicscraper.models.TidalMetadataResult
import com.alzimer.echobox.kotlinytmusicscraper.models.VideoItem
import com.alzimer.echobox.kotlinytmusicscraper.models.WatchEndpoint
import com.alzimer.echobox.kotlinytmusicscraper.models.YTItemType
import com.alzimer.echobox.kotlinytmusicscraper.models.YouTubeClient
import com.alzimer.echobox.kotlinytmusicscraper.models.YouTubeClient.Companion.TVHTML5
import com.alzimer.echobox.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB
import com.alzimer.echobox.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB_REMIX
import com.alzimer.echobox.kotlinytmusicscraper.models.YouTubeLocale
import com.alzimer.echobox.kotlinytmusicscraper.models.getContinuation
import com.alzimer.echobox.kotlinytmusicscraper.models.oddElements
import com.alzimer.echobox.kotlinytmusicscraper.models.response.AccountMenuResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.AccountSwitcherEndpointResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.AddItemYouTubePlaylistResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.BrowseResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.CreatePlaylistResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.ImageUploadResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.DownloadProgress
import com.alzimer.echobox.kotlinytmusicscraper.models.response.GetQueueResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.GetSearchSuggestionsResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.LikeStatus
import com.alzimer.echobox.kotlinytmusicscraper.models.response.NextAndroidMusicResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.NextResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.PipedResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.PlayerResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.SearchResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.EchoBoxChartResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.TidalSearchResponse
import com.alzimer.echobox.kotlinytmusicscraper.models.response.TidalOAuthResponse
...
import com.alzimer.echobox.kotlinytmusicscraper.models.youtube.Transcript
import com.alzimer.echobox.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import com.alzimer.echobox.kotlinytmusicscraper.models.youtube.tryDecodeText
import com.alzimer.echobox.kotlinytmusicscraper.pages.AlbumPage
import com.alzimer.echobox.kotlinytmusicscraper.pages.ArtistPage
import com.alzimer.echobox.kotlinytmusicscraper.pages.ArtistSection
import com.alzimer.echobox.kotlinytmusicscraper.pages.BrowseResult
import com.alzimer.echobox.kotlinytmusicscraper.pages.ExplorePage
import com.alzimer.echobox.kotlinytmusicscraper.pages.MoodAndGenres
import com.alzimer.echobox.kotlinytmusicscraper.pages.NextPage
import com.alzimer.echobox.kotlinytmusicscraper.pages.NextResult
import com.alzimer.echobox.kotlinytmusicscraper.pages.PlaylistContinuationPage
import com.alzimer.echobox.kotlinytmusicscraper.pages.PlaylistPage
import com.alzimer.echobox.kotlinytmusicscraper.pages.RelatedPage
import com.alzimer.echobox.kotlinytmusicscraper.pages.SearchPage
import com.alzimer.echobox.kotlinytmusicscraper.pages.SearchResult
import com.alzimer.echobox.kotlinytmusicscraper.pages.SearchSuggestionPage
import com.alzimer.echobox.kotlinytmusicscraper.parser.fromPlaylistContinuationToTracks
import com.alzimer.echobox.kotlinytmusicscraper.parser.fromPlaylistToTrack
import com.alzimer.echobox.kotlinytmusicscraper.parser.fromPlaylistToTrackWithSetVideoId
import com.alzimer.echobox.kotlinytmusicscraper.parser.getContinuePlaylistContinuation
import com.alzimer.echobox.kotlinytmusicscraper.parser.getPlaylistContinuation
import com.alzimer.echobox.kotlinytmusicscraper.parser.getReloadParams
import com.alzimer.echobox.kotlinytmusicscraper.parser.getSuggestionSongItems
import com.alzimer.echobox.kotlinytmusicscraper.parser.hasReloadParams
 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with EchoBox
 *
...
class YouTube {
     ...
     * In EchoBox, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function
...
//        }
    ...
    suspend fun getEchoBoxChart() =
        runCatching {
            ytMusic.getEchoBoxChart().body<EchoBoxChartResponse>()
        }
     ...
     * if it has not been extracted yet. Diagnostic only — see [com.alzimer.echobox.kotlinytmusicscraper.extractor.ExtractSource].
     */
