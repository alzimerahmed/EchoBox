...
import com.alzimer.echobox.kotlinytmusicscraper.extractor.Extractor
...
import com.alzimer.echobox.kotlinytmusicscraper.models.YouTubeClient.Companion.IOS
...
import com.alzimer.echobox.kotlinytmusicscraper.models.body.AccountMenuBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.BrowseBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.CreatePlaylistBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.EditPlaylistBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.FormData
import com.alzimer.echobox.kotlinytmusicscraper.models.body.GetQueueBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.GetSearchSuggestionsBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.LikeBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.SubscribeBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.NextBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.PlayerBody
import com.alzimer.echobox.kotlinytmusicscraper.models.body.SearchBody
...
import com.alzimer.echobox.kotlinytmusicscraper.utils.parseCookieString
import com.alzimer.echobox.kotlinytmusicscraper.utils.sha1
import com.alzimer.echobox.ktorext.curl.CurlLogger
import com.alzimer.echobox.ktorext.encoding.brotli
import com.alzimer.echobox.ktorext.getEngine
...
//                    },
    ...
    suspend fun checkForGithubReleaseUpdate() =
        httpClient.get("https://api.github.com/repos/alzimerahmed/EchoBox/releases/latest") {
            contentType(ContentType.Application.Json)
        }
