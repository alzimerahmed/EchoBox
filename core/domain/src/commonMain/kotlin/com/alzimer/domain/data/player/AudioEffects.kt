package com.alzimer.echobox.domain.data.player
 ...
 * the same reason [com.alzimer.echobox.domain.data.player.GenericPlaybackParameters] is: a player can tell
...
/**
 * Both audio effects as one value, which is what [com.alzimer.echobox.domain.mediaservice.player.MediaPlayerInterface.setAudioEffects]
 * takes.
 *
