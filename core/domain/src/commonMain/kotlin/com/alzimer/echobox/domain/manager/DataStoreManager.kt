package com.alzimer.echobox.domain.manager
...
interface DataStoreManager {
     ...
     * of [com.alzimer.echobox.lyrics.romanization.RomanizationLanguage] NAMES — empty string means the
     ...
     * written back into the cached [com.alzimer.echobox.domain.data.model.metadata.Line] rows, the
    ...
    val localFilesEnabled: Flow<String>

    suspend fun setLocalFilesEnabled(enabled: Boolean)

    val localFilesLastScan: Flow<Long>
