...
/**
 * Writes a file produced by the EchoBox web converter into the local database.
 *
 ...
 *
 * [com.alzimer.echobox.domain.utils.LocalResource.Loading] carries no payload, so it cannot say "X of Y
