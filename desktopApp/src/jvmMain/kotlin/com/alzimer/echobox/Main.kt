...
/**
 * Thin entry point for EchoBox Desktop.
 *
 ...
 */
/**
 * Force the X11 WM_CLASS so the Linux taskbar/dock shows "EchoBox" instead of
 ...
 */
private fun forceLinuxWmClass(appName: String = "EchoBox") {
