...
-keep class com.alzimer.echobox.domain.data.model.** { *; }
...
-keep class com.alzimer.echobox.data.model.** { *; }
-keep class com.alzimer.echobox.extension.AllExtKt { *; }
-keep class com.alzimer.echobox.extension.AllExtKt$* { *; }
-keep class com.alzimer.echobox.kotlinytmusicscraper.extension.MapExtKt$* { *; }
...
-dontwarn com.alzimer.echobox.data.di.loader.LoaderKt
-dontwarn com.alzimer.echobox.media3.ui.MediaPlayerViewKt
...
-keep class com.alzimer.echobox.data.di.** { *; }
