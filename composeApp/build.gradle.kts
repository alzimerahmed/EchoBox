...
val mpvSetupLinuxCi by tasks.registering {
    ...
    doLast {
        ...
        val tag = "echobox-libmpv:$mpvVersion"
...
// vlcSetupAll.
// ===========================================================================
// Kept in a repo of its own rather than EchoBox's own releases: these archives are ~196 MB per
...
buildkonfig {
    packageName = "com.alzimer.echobox"
