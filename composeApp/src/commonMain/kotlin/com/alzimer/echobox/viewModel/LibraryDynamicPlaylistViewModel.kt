...
import com.alzimer.echobox.common.Config.REMOVED_SONG_DATE_TIME
...
import com.alzimer.echobox.ui.screen.home.analytics.monthFullNameResource
...
class LibraryDynamicPlaylistViewModel(
     ...
     * [com.alzimer.echobox.domain.repository.AnalyticsRepository], then each row's `videoId` paired with
