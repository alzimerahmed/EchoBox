...
import com.alzimer.echobox.expect.ui.PlatformWebView
import com.alzimer.echobox.expect.ui.createWebViewCookieManager
import com.alzimer.echobox.expect.ui.rememberWebViewState
import com.alzimer.echobox.ui.component.DevLogInBottomSheet
import com.alzimer.echobox.ui.component.DevLogInType
import com.alzimer.echobox.ui.component.RippleIconButton
import com.alzimer.echobox.ui.icon.ArrowBackIosNew
import com.alzimer.echobox.ui.icon.LogoDev
...
import echobox.composeapp.generated.resources.log_in
import echobox.composeapp.generated.resources.login_failed
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is com.alzimer.echobox.expect.ui.WebViewState.Finished -> "Finished"
                        is com.alzimer.echobox.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
