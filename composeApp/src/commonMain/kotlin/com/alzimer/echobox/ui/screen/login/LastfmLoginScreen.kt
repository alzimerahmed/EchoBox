package com.alzimer.echobox.ui.screen.login
...
import com.alzimer.echobox.viewModel.LastfmLoginState
...
import echobox.composeapp.generated.resources.lastfm_login_step_1
import echobox.composeapp.generated.resources.lastfm_login_step_2
import echobox.composeapp.generated.resources.lastfm_open_authorize_page
import echobox.composeapp.generated.resources.lastfm_paste_callback_confirm
import echobox.composeapp.generated.resources.lastfm_paste_callback_hint
import echobox.composeapp.generated.resources.lastfm_paste_callback_title
...
/**
 * Last.fm's desktop auth flow, which is what EchoBox uses on every platform.
 *
 * There is no WebView here on purpose — unlike the Discord and Spotify screens, this never sees the
 * user's password. EchoBox asks Last.fm for a request token, sends the user to Last.fm's own page
