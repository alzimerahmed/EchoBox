package com.alzimer.echobox.ui.navigation.destination.home
 ...
 * and would let a deep link ask for a year with no [com.alzimer.echobox.domain.data.entities.analytics.PlaybackEventEntity]
 * rows behind it.
 */
@Serializable
