# CLAUDE.md - EchoBox Project Guide for AI Agents
...
**EchoBox** is a FOSS (Free and Open Source Software) YouTube Music client for Android and Desktop, built with Compose Multiplatform.
...
### Basic Information
- **Package name**: `com.alzimer.echobox`
...
- **lyricsService/**: Lyrics fetching (LRCLIB, EchoBox Lyrics, BetterLyrics)
...
**Location**: `composeApp/src/commonMain/kotlin/com/alzimer/echobox/echobox/ui/icon/`
...
1. `package com.example.test` → `package com.alzimer.echobox.ui.icon`
...
**Use it:** `SimpIcons.PlayArrow` — plus a per-icon import, `import com.alzimer.echobox.ui.icon.PlayArrow`.
...
- **Features**:
  - Deep link support (`echobox://` and `simpmusic.org`)
...
**Location**: `core/media/media-jvm/src/main/java/com/echobox/media_jvm/mpv/`
...
**Location**: `core/media/media3/src/main/java/com/alzimer/echobox/media3/exoplayer/CrossfadeExoPlayerAdapter.kt`
...
### Translation
- Use Crowdin: https://crowdin.com/project/echobox
...
- **EchoBox Chart**: Chart playlists integrated into Library screen
...
- **EchoBox Lyrics voting**: Vote functionality for community lyrics
...
- **Deep link support**: `echobox://` and `simpmusic.org` URL schemes
...
*This document helps AI Agents quickly understand the EchoBox project. Update regularly when there are major changes to architecture or structure.*

**Last updated**: 2026-09-12
**Project version**: Check latest release on GitHub
**Maintained by**: alzimerahmed84 and contributors
