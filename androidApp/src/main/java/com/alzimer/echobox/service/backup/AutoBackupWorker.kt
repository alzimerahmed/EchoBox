package com.alzimer.echobox.service.backup
...
import com.alzimer.echobox.common.DOWNLOAD_EXOPLAYER_FOLDER
import com.alzimer.echobox.common.EXOPLAYER_DB_NAME
...
class AutoBackupWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        try {
            ...
            // Save to Downloads/EchoBox folder
    ...
    private fun saveToDownloads(backupFile: File): Boolean {
        ...
        val fileName = "echobox_backup_$timestamp.zip"
        ...
        return try {
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    put(MediaStore.Downloads.RELATIVE_PATH, "Download/EchoBox")
                }
            }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/EchoBox/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                arrayOf("Download/EchoBox/", "echobox_backup_%.zip")
            } else {
                arrayOf("echobox_backup_%.zip")
            }
            ...
            context.contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (name.startsWith("echobox_backup_") && name.endsWith(".zip")) {
