package com.alzimer.echobox.service.rss
...
import com.alzimer.echobox.domain.extension.epochMillisToLocalDateTime
...
import com.alzimer.echobox.service.test.notification.NotificationHandler
...
class RssFeedNotifyWork(
    ...
    private fun fetchFeed(urlStr: String): String {
        val connection =
            (URL(urlStr).openConnection() as HttpURLConnection).apply {
                ...
                readTimeout = 15_000
                requestMethod = "GET"
                setRequestProperty("User-Agent", "EchoBox")
            }
        return try {
    ...
    companion object {
        ...
        const val FEED_URL = "https://www.alzimer.dev/rss.xml"
