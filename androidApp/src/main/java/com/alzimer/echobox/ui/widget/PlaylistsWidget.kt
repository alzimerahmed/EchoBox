...
import com.alzimer.echobox.MainActivity
import com.alzimer.echobox.R
 ...
 *
 * Tiles open `echobox://…` rather than passing extras: a widget tap often arrives with the app
        ...
        RecentlyType.Type.SONG ->
            (this as? SongEntity)?.let {
                PlaylistTile(
                    ...
                    uri = "echobox://watch?v=${it.videoId}",
                    song = it,
                )
            }
        ...
        RecentlyType.Type.ALBUM ->
            (this as? AlbumEntity)?.let {
                PlaylistTile(
                    ...
                    uri = "echobox://album?id=${it.browseId}",
                )
            }
        ...
        RecentlyType.Type.PLAYLIST ->
            (this as? PlaylistEntity)?.let {
                PlaylistTile(
                    ...
                    uri = "echobox://playlist?list=${it.id}",
                )
            }
        ...
        RecentlyType.Type.ARTIST ->
            (this as? ArtistEntity)?.let {
                PlaylistTile(
                    ...
                    uri = "echobox://channel/${it.channelId}",
                )
            }
    }
